...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // 2. CHECK STATUS (users with banned status cannot log in)
     ...
     //optimization De-normalization (Phone/Name) and Vertical Partitioning (Details)
